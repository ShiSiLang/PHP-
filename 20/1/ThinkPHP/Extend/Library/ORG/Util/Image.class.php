...
class Image {
     ...
     * @return string
     */
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=88, $height=42, $verifyName='verify') {
...
//        }
        ...
        $fontPath = THINK_PATH."/Common/ERASDEMI.TTF";
        for ($i = 0; $i < $length; $i++) {
//            imagestring($im, 5, $i * 10 + 5, mt_rand(1, 8), $randval{$i}, $stringColor);
            imagettftext($im, 20, mt_rand(-30,30) , $i * 16 + 5, $height/1.4, $stringColor, $fontPath, $randval{$i});
        }
